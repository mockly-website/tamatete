document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    ...
    'about.title':     { it:'Benvenuti da <span class="text-accent">Bistrot L\'Incontro</span>', en:'Welcome to <span class="text-accent">Bistrot L\'Incontro</span>', fr:'Bienvenue chez <span class="text-accent">Bistrot L\'Incontro</span>', es:'Bienvenidos a <span class="text-accent">Bistrot L\'Incontro</span>' },
    'about.p1':        { it:'Bistrot L\'Incontro nasce nel cuore di Oristano, nell\'elegante <strong>Corso Umberto I</strong>, a pochi passi dal Museo Antiquarium Arborense. Un luogo dove la tradizione culinaria sarda e mediterranea si fonde con influenze internazionali per offrire un\'esperienza unica.', en:'Bistrot L\'Incontro is located in the heart of Oristano, on the elegant <strong>Corso Umberto I</strong>, just steps from the Museo Antiquarium Arborense. A place where Sardinian and Mediterranean culinary traditions blend with international influences to offer a unique experience.', fr:'Bistrot L\'Incontro est situé au cœur d\'Oristano, sur l\'élégante <strong>Corso Umberto I</strong>, à deux pas du Musée Antiquarium Arborense. Un lieu où la tradition culinaire sarde et méditerranéenne se mêle aux influences internationales pour offrir une expérience unique.', es:'Bistrot L\'Incontro se encuentra en el corazón de Oristano, en la elegante <strong>Corso Umberto I</strong>, a pocos pasos del Museo Antiquarium Arborense. Un lugar donde la tradición culinaria sarda y mediterránea se fusiona con influencias internacionales para ofrecer una experiencia única.' },
    'about.p2':        { it:'A guidare il locale è <strong>Marco</strong>, la cui passione per l\'accoglienza e la cucina di qualità si riflette in ogni piatto e in ogni dettaglio del servizio. L\'atmosfera raccolta della sala interna si alterna alla suggestione del cortile esterno e dei tavoli in piazza, illuminati la sera per una cena all\'insegna della convivialità.', en:'The restaurant is led by <strong>Marco</strong>, whose passion for hospitality and quality cuisine is reflected in every dish and every detail of the service. The intimate atmosphere of the indoor dining room alternates with the charm of the outdoor courtyard and the tables in the square, illuminated in the evening for a dinner of true conviviality.', fr:'Le restaurant est dirigé par <strong>Marco</strong>, dont la passion pour l\'accueil et la cuisine de qualité se reflète dans chaque plat et chaque détail du service. L\'atmosphère intime de la salle intérieure alterne avec le charme de la cour extérieure et des tables sur la place, illuminées le soir pour un dîner placé sous le signe de la convivialité.', es:'El restaurante está dirigido por <strong>Marco</strong>, cuya pasión por la hospitalidad y la cocina de calidad se refleja en cada plato y en cada detalle del servicio. La atmósfera íntima del comedor interior se alterna con el encanto del patio exterior y las mesas en la plaza, iluminadas por la noche para una cena llena de convivialidad.' },
    ...
    'gallery.desc':    { it:'Piatti, atmosfere e momenti conviviali da Bistrot L\'Incontro.', en:'Dishes, atmospheres and convivial moments at Bistrot L\'Incontro.', fr:'Plats, ambiances et moments conviviaux chez Bistrot L\'Incontro.', es:'Platos, ambientes y momentos de convivencia en Bistrot L\'Incontro.' },
    ...
    'reserve.form.disclaimer':{ it:'Oppure scrivici su <a href="https://wa.me/390783333333" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> WhatsApp</a> o chiama il <a href="tel:+390783333333"><i class="fas fa-phone"></i> 0783 333333</a>', en:'Or write to us on <a href="https://wa.me/390783333333" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> WhatsApp</a> or call <a href="tel:+390783333333"><i class="fas fa-phone"></i> 0783 333333</a>', fr:'Ou écrivez-nous sur <a href="https://wa.me/390783333333" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> WhatsApp</a> ou appelez le <a href="tel:+390783333333"><i class="fas fa-phone"></i> 0783 333333</a>', es:'O escríbenos por <a href="https://wa.me/390783333333" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> WhatsApp</a> o llama al <a href="tel:+390783333333"><i class="fas fa-phone"></i> 0783 333333</a>' },
    'contact.tag':         { it:'Contatti', en:'Contact', fr:'Contact', es:'Contacto' },
    'contact.title':       { it:'Trova <span class="text-accent">Bistrot L\'Incontro</span>', en:'Find <span class="text-accent">Bistrot L\'Incontro</span>', fr:'Trouvez <span class="text-accent">Bistrot L\'Incontro</span>', es:'Encuentra <span class="text-accent">Bistrot L\'Incontro</span>' },
    'contact.desc':        { it:'Siamo nel centro storico di Oristano, a pochi passi dal Museo Antiquarium Arborense.', en:'We are in the historic center of Oristano, just steps from the Museo Antiquarium Arborense.', fr:'Nous sommes dans le centre historique d\'Oristano, à deux pas du Musée Antiquarium Arborense.', es:'Estamos en el centro histórico de Oristano, a pocos pasos del Museo Antiquarium Arborense.' },
    ...
    'footer.copyright':     { it:'&copy; 2026 Bistrot L\'Incontro – Ristorante Bistrot. Tutti i diritti riservati.', en:'&copy; 2026 Bistrot L\'Incontro – Restaurant Bistrot. All rights reserved.', fr:'&copy; 2026 Bistrot L\'Incontro – Restaurant Bistrot. Tous droits réservés.', es:'&copy; 2026 Bistrot L\'Incontro – Restaurante Bistrot. Todos los derechos reservados.' },
  ...
  function translateStatic(lang) {
    ...
    if (page !== 'legal') {
      const pageTitles = {
        home: { it:'Bistrot L\'Incontro – Ristorante Bistrot | Oristano', en:'Bistrot L\'Incontro – Restaurant Bistrot | Oristano', fr:'Bistrot L\'Incontro – Restaurant Bistrot | Oristano', es:'Bistrot L\'Incontro – Restaurante Bistrot | Oristano' },
        menu: { it:'Menu – Bistrot L\'Incontro | Oristano', en:'Menu – Bistrot L\'Incontro | Oristano', fr:'Menu – Bistrot L\'Incontro | Oristano', es:'Menú – Bistrot L\'Incontro | Oristano' },
        contatti: { it:'Contatti e Prenotazioni – Bistrot L\'Incontro | Oristano', en:'Contact & Booking – Bistrot L\'Incontro | Oristano', fr:'Contact & Réservation – Bistrot L\'Incontro | Oristano', es:'Contacto y Reservas – Bistrot L\'Incontro | Oristano' }
      };
  ...
  if (form) {
    ...
    form.addEventListener('submit', (e) => {
      ...
      const msg = encodeURIComponent(
        `Ciao Bistrot L'Incontro! Vorrei prenotare un tavolo.\n\nNome: ${name}\nTelefono: ${phone}\nData: ${date}\nOra: ${time}\nCoperti: ${guests}${notes ? `\nNote: ${notes}` : ''}\n\nGrazie!`
      );
      ...
      btn.disabled = true;
      setTimeout(() => {
        window.open(`https://wa.me/390783333333?text=${msg}`, '_blank');
